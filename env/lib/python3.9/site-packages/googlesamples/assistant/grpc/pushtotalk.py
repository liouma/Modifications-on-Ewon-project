...
#new imports for emotions :
from emotions_fr import emotions
        ...
        while True:
            if first:
                ...
                if current_emotion != previous_emotion:
                    previous_emotion = current_emotion
                    animateServosAndDisplay(current_emotion)
                    print("animating emotion=",current_emotion)
...
#                if lastFlag:
                ...
                lastFlag = 0
                final = resp.result.spoken_request_text
...
def main(api_endpoint, credentials, verbose,
    ...
    with SampleAssistant(conversation_stream,
        ...
        while True:
            #liouma a commenté ces deux lignes:
