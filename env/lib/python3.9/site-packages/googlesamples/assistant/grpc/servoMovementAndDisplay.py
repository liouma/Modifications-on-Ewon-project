...
"""def display(images):
    os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/sample.jpeg'")
    for i in images:
        ser.write(b"p0.pic=")
        ser.write(bytes(str(i), 'utf-8'))
        ser.write(b"\xff\xff\xff")
        time.sleep(0.1)"""
# In this version I use fbi to display the image on Ewon's screen. It is just a proof of concept.
# fbi is too slow for an animation, so later I will need to optimize the images (maybe gif anim)

def display(emotion):
    if emotion == "listen":
        os.system("sudo fbi -T 2 --readahead -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad1.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad2.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad3.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad4.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad5.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad6.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/sad7.jpg'")
    ...
    if emotion == "happy":
#        os.system("sudo fbi -t 0.2 -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy1.png' '/home/liouma/Ewon/images/happy2.png' '/home/liouma/Ewon/images/happy3.png' '/home/liouma/Ewon/images/happy4.png' '/home/liouma/Ewon/images/happy5.png' '/home/liouma/Ewon/images/happy6.png' '/home/liouma/Ewon/images/happy7.png'")
        os.system("sudo fbi -T 2 --readahead -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy1.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy2.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy3.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy4.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy5.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy6.png'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/happy7.png'")

    if emotion == "angry":
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry1.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry2.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry3.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry4.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry5.jpg'")
        time.sleep(0.2)
        os.system("sudo fbi -T 2 -d /dev/fb1 -noverbose -a '/home/liouma/Ewon/images/angry6.jpg'")
